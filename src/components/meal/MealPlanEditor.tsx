...
export const MealPlanEditor: React.FC = () => {
  ...
  const [userId, setUserId] = useState<string>('1'); // Default to user ID 1
  ...
  }, [initializeMealPlan, getMealPlanForUser, userId]);
  ...
  const updateTotalMacros = (updatedMeals: typeof meals) => {
    ...
    if (mealPlan?.calorieAdjustment) {
      newTotalMacroRange.min.calories += mealPlan.calorieAdjustment;
      newTotalMacroRange.max.calories += mealPlan.calorieAdjustment;
    }
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6" dir="rtl">
      ...
      <div className="bg-gradient-to-r from-gray-800 to-gray-900 rounded-xl shadow-lg p-6 border-b-4 border-purple-900">
        ...
        {/* Help panel */}
        {showHelp && (
          <div className="mb-6 bg-gray-800/70 rounded-xl p-4 border-2 border-purple-700/30 space-y-3">
              ...
              <div>
                ...
                <ul className="space-y-2 text-purple-200 text-sm">
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>לחץ על <span className="bg-purple-900 px-2 py-0.5 rounded-full text-purple-200 font-bold">התאמת תוכנית</span> לביצוע התאמות מדויקות.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="font-bold text-purple-400 mt-0.5">5.</span>
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          ...
          <div className="relative p-4 bg-gray-800/70 rounded-lg border-2 border-purple-700/30 hover:border-purple-700 transition-all duration-200">
            <label className="block text-sm font-medium text-purple-200 mb-2">בחר תבנית קיימת</label>
            <div className="relative">
              <select
                className="w-full p-2 pr-4 pl-10 border-2 border-gray-700 rounded-lg appearance-none bg-gray-800 text-gray-200 focus:border-purple-600 focus:ring focus:ring-purple-700 focus:ring-opacity-50 cursor-pointer shadow-sm hover:shadow transition-all duration-200"
                onChange={(e) => {
                  if (e.target.value !== 'no-template') {
                    loadTemplate(e.target.value, userId);
                  }
                }}
          ...
          <div className="p-4 bg-gray-800/70 rounded-lg border-2 border-green-700/30 hover:border-green-700 transition-all duration-200">
            <div className="mb-2">
          ...
          <div className="col-span-2 p-4 bg-gray-800/70 rounded-lg border-2 border-purple-700/30 hover:border-purple-700 transition-all duration-200">
            <div className="flex items-center justify-between">
              ...
              <button
                onClick={() => toggleHideMacros(userId)}
        ...
        <div className="mb-4">
          ...
          {/* Calorie adjustment indicator */}
          {mealPlan?.calorieAdjustment && (
            <div className="mt-3 p-3 bg-blue-900/30 rounded-lg border border-blue-800/40 text-blue-200 text-sm flex items-center gap-2">
              <Info className="h-4 w-4 text-blue-400" />
              <span>
                {mealPlan.calorieAdjustment > 0 
                  ? `נוספו ${mealPlan.calorieAdjustment} קלוריות ליום בהתאמה אחרונה.`
                  : `הופחתו ${Math.abs(mealPlan.calorieAdjustment)} קלוריות ליום בהתאמה אחרונה.`
                }
              </span>
            </div>
          )}
